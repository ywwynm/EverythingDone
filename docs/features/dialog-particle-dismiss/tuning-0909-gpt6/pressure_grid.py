...
class PressureGrid:
    ...
    def resolve(self):
        ...
        self.project['iteration']=100;self.project.run(group_x=(self.shape[0]+15)//16,group_y=(self.shape[1]+15)//16);self.barrier();self.texture.use(5)
    def close(self):
