...
### Move the Aliyun update source to HTTPS (deferred 2026-05-28)
...
### Design the release update channel before publishing release builds (deferred 2026-05-28)
...
### Configure and smoke-test the Aliyun debug update channel (deferred 2026-05-28)
