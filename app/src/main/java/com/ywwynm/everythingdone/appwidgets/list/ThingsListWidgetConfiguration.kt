...
open class ThingsListWidgetConfiguration : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val color: Int = DisplayUtil.getRandomColor(getApplicationContext())
        val tvTitle: TextView? = findViewById(R.id.tv_title_things_list_widget_configuration) as TextView?
        if (tvTitle != null) {
            tvTitle.setTextColor(color)
        }
        val tvConfirm: TextView? = findViewById(R.id.tv_confirm_as_bt_things_list_config) as TextView?
        if (tvConfirm != null) {
        ...
        mSbAlpha = findViewById(R.id.sb_app_widget_alpha) as SeekBar
        mSbAlpha!!.setMax(100)
        DisplayUtil.setSeekBarColor(mSbAlpha, color)

        mCbSimpleView = findViewById(R.id.cb_simple_view) as AppCompatCheckBox
        ...
        mCbAlphaHeader = findViewById(R.id.cb_alpha_header) as AppCompatCheckBox
        ...
        val dao: AppWidgetDAO = AppWidgetDAO.getInstance(getApplicationContext())!!
    ...
    open fun onConfirmClicked(view: View?) {
        ...
        var alpha: Int = mSbAlpha!!.getProgress()
